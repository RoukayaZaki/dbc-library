...
///
/// Users should define private methods and constructors (e.g., `_methodName` or `_ConstructorName`) 
/// with relevant annotations (`@Precondition`, `@Postcondition`, or `@Invariant`).
/// Public methods and constructors are generated by the package, which enforce the specified contract checks.
///
/// Example:
/// ```dart
/// @Contract({
...
///   final int balance;
///
///   // Private constructor with a precondition.
///   @Precondition({
///     'initialBalance >= 0': 'Initial balance must be non-negative.',
///   })
///   Wallet._(this.balance);
///
...
///
/// ### Key Notes:
/// - **Private Methods and Constructors Only**: Users define private methods (e.g., `_methodName`) and constructors (e.g., `Wallet._`).
/// - **Generated Public Methods and Constructors**:
///   - Public methods (e.g., `methodName`) and constructors (e.g., `Wallet()`) are automatically generated by the package.
///   - Generated public methods and constructors include all necessary preconditions, postconditions, and invariant checks.
/// - **Class-Level Invariants**:
///   - Declared using `@Contract` and enforced in all generated public methods and constructors.
///
...
/// Use this annotation to specify preconditions for a private method or constructor.
///
/// Preconditions are conditions that must be satisfied **before** the method or constructor is executed.
/// These conditions ensure that the inputs or state of the system meet the required criteria
/// for the method or constructor to execute safely and correctly.
///
/// [asserts] is a map where:
/// - **Key**: A string representing a condition (a valid Dart expression).
/// - **Value**: A string containing an assertion message that describes what the condition enforces.
///
/// Preconditions are applied to the public method or constructor generated from the annotated private method or constructor.
///
/// Example:
/// ```dart
/// // Private constructor with a precondition.
...
/// Use this annotation to enforce class-level invariants on a private method or constructor.
///
/// The `@Invariant` annotation ensures that the invariants specified in the `@Contract` annotation
/// are checked **before** and **after** the execution of the annotated private method or constructor.
///
/// This annotation is intended for private methods or constructors that do not have explicit 
...
///
/// Invariants are applied to the public method or constructor generated from the annotated private method or constructor.
///
/// Example:
/// ```dart
/// @Contract({
